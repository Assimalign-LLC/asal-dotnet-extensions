...
using Assimalign.Extensions.Configuration.Ini;
using Assimalign.Extensions.Configuration.Json;
using Assimalign.Extensions.Configuration.UserSecrets;
using Assimalign.Extensions.Configuration.Xml;
using Assimalign.Extensions.FileProviders;
using Assimalign.Extensions.Primitives;
using Xunit;

namespace Assimalign.Extensions.Configuration.Test
{
