...
namespace Assimalign.Extensions.DependencyInjection.Tests
{
    public abstract class ServiceProviderContainerTests : DependencyInjectionSpecificationTests
    {
        ...
        public void ProviderDisposeThrowsWhenOnlyDisposeAsyncImplemented()
        {
            ...
            Assert.Equal(
                "'Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderContainerTests+AsyncDisposable' type only implements IAsyncDisposable. Use DisposeAsync to dispose the container.",
                exception.Message);
        }
