...
public abstract class ServiceProviderContainerTests : ServiceProviderIoCSpecificationTests
{
    [Fact]
    ...
    public void ProviderDisposeThrowsWhenOnlyDisposeAsyncImplemented()
    {
        ...
        Assert.Equal(
            "'Assimalign.Extensions.DependencyInjection.ServiceProviderContainerTests+AsyncDisposable' type only implements IAsyncDisposable. Use DisposeAsync to dispose the container.",
            exception.Message);
    }
