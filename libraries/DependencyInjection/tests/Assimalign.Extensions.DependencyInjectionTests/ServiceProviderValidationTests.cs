...
namespace Assimalign.Extensions.DependencyInjection.Tests
{
    public class ServiceProviderValidationTests
    {
        ...
        public void BuildServiceProvider_ValidateOnBuild_ThrowsForUnresolvableServices()
        {
            ...
            Assert.Equal("Error while validating the service descriptor 'ServiceType: Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+IFoo Lifetime: Transient ImplementationType: Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+Foo': " +
                         "Unable to resolve service for type 'Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+IBar' while attempting to activate" +
                         " 'Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+Foo'.",
                aggregateException.InnerExceptions[0].Message);

            Assert.Equal("Error while validating the service descriptor 'ServiceType: Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz Lifetime: Transient ImplementationType: Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+BazRecursive': " +
                         "A circular dependency was detected for the service of type 'Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz'." + Environment.NewLine +
                         "Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz(Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+BazRecursive) ->" +
                         " Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz",
        ...
        public void BuildServiceProvider_ValidateOnBuild_ThrowsWhenImplementationIsNotAssignableToService()
        {
            ...
            Assert.Equal("Error while validating the service descriptor 'ServiceType: Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz Lifetime: Transient ImplementationType: Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+Boo': " +
                         "Implementation type 'Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+Boo' can't be converted to service type 'Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz'",
                         aggregateException.InnerExceptions[0].Message);

            Assert.Equal("Error while validating the service descriptor 'ServiceType: Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+IFoo Lifetime: Singleton ImplementationInstance: System.Object': " +
                         "Constant value of type 'System.Object' can't be converted to service type 'Assimalign.Extensions.DependencyInjection.Tests.ServiceProviderValidationTests+IFoo'",
                         aggregateException.InnerExceptions[1].Message);
        }
