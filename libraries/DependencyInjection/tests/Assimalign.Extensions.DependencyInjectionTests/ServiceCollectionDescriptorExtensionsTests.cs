        ...
        {
            {
                ...
                "ServiceType: Assimalign.Extensions.DependencyInjection.Specification.Fakes.IFakeService Lifetime: Scoped ImplementationType: Assimalign.Extensions.DependencyInjection.Specification.Fakes.FakeService"
            },
            {
                new ServiceDescriptor(typeof(IFakeService), typeof(FakeService), ServiceLifetime.Singleton),
                "ServiceType: Assimalign.Extensions.DependencyInjection.Specification.Fakes.IFakeService Lifetime: Singleton ImplementationType: Assimalign.Extensions.DependencyInjection.Specification.Fakes.FakeService"
            },
            {
                new ServiceDescriptor(typeof(IFakeService), typeof(FakeService), ServiceLifetime.Transient),
                "ServiceType: Assimalign.Extensions.DependencyInjection.Specification.Fakes.IFakeService Lifetime: Transient ImplementationType: Assimalign.Extensions.DependencyInjection.Specification.Fakes.FakeService"
            },
            {
                new ServiceDescriptor(typeof(IFakeService), new FakeServiceToString()),
                "ServiceType: Assimalign.Extensions.DependencyInjection.Specification.Fakes.IFakeService Lifetime: Singleton ImplementationInstance: [FakeServiceToString]"
            },
            {
                new ServiceDescriptor(typeof(IFakeService), CreateFakeService, ServiceLifetime.Scoped),
                "ServiceType: Assimalign.Extensions.DependencyInjection.Specification.Fakes.IFakeService Lifetime: Scoped ImplementationFactory: Assimalign.Extensions.DependencyInjection.Specification.Fakes.FakeService CreateFakeService(System.IServiceProvider)"
            },
            {
                new ServiceDescriptor(typeof(IFakeService), CreateFakeService, ServiceLifetime.Singleton),
                "ServiceType: Assimalign.Extensions.DependencyInjection.Specification.Fakes.IFakeService Lifetime: Singleton ImplementationFactory: Assimalign.Extensions.DependencyInjection.Specification.Fakes.FakeService CreateFakeService(System.IServiceProvider)"
            },
            {
                new ServiceDescriptor(typeof(IFakeService), CreateFakeService, ServiceLifetime.Transient),
                "ServiceType: Assimalign.Extensions.DependencyInjection.Specification.Fakes.IFakeService Lifetime: Transient ImplementationFactory: Assimalign.Extensions.DependencyInjection.Specification.Fakes.FakeService CreateFakeService(System.IServiceProvider)"
            },
        };
