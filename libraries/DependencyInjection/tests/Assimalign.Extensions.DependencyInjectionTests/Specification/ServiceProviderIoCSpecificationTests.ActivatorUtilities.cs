...
public abstract partial class ServiceProviderIoCSpecificationTests
{
    ...
    public void CreateInstance_WithAbstractTypeAndPublicConstructor_ThrowsCorrectException()
    {
        ...
        var msg = "A suitable constructor for type 'Assimalign.Extensions.DependencyInjection.ServiceProviderIoCSpecificationTests+AbstractFoo' could not be located. Ensure the type is concrete and all parameters of a public constructor are either registered as services or passed as arguments. Also ensure no extraneous arguments are provided.";
