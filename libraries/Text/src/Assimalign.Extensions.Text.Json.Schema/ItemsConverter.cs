...
{
    /// <summary>
    /// Converts a property of type <see cref="JsonSchemaItems"/> to or from a string
    ...
    public class ItemsConverter : JsonConverter
    {
        ...
        {
            return objectType == typeof(JsonSchemaItems);
        }
        ...
        {
            var items = (JsonSchemaItems)value;
