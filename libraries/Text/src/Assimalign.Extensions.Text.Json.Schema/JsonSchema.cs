...
public class JsonSchema : IEquatable<JsonSchema>
{
    ...
    public JsonSchema(JsonSchema other)
    {
        if (other.Id != null)
        {
            Id = new JsonSchemaUriOrFragment(other.Id);
        }
        ...
        if (other.Type != null)
        {
            Type = new List<JsonSchemaType>(other.Type);
        }
        ...
        if (other.Items != null)
        {
            Items = new JsonSchemaItems(other.Items);
        }
        ...
        {
            Reference = new JsonSchemaUriOrFragment(other.Reference);
        }
    ...
    /// </remarks>
    public JsonSchemaUriOrFragment Id { get; set; }
    ...
    public IList<JsonSchemaType> Type { get; set; }
    ...
    /// </summary>
    /// <remarks>
    /// This property applies only to schemas whose <see cref="Type"/> is <see cref="JsonSchemaType.Array"/>.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// This property applies only to schemas whose <see cref="Type"/> is <see cref="JsonSchemaType.Object"/>.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// This property applies only to schemas whose <see cref="Type"/> is <see cref="JsonSchemaType.String"/>.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// This property applies only to schemas whose <see cref="Type"/> is <see cref="JsonSchemaType.Integer"/>
    /// or <see cref="JsonSchemaType.Number"/>.
    /// </remarks>
    ...
    /// <remarks>
    /// This property applies only to schemas whose <see cref="Type"/> is <see cref="JsonSchemaType.Integer"/>
    /// or <see cref="JsonSchemaType.Number"/>. If not specified in the schema, the default
    ...
    public JsonSchemaUriOrFragment Reference { get; set; }
    ...
    private static JsonSchema Collapse(JsonSchema schema, JsonSchema rootSchema)
    {
        ...
        {
            collapsedSchema.Items = new JsonSchemaItems(
                new List<JsonSchema>(
        ...
        if (schema.Reference != null)
        {
            ...
            {
                collapsedSchema.Type = new List<JsonSchemaType>(referencedSchema.Type);
            }
