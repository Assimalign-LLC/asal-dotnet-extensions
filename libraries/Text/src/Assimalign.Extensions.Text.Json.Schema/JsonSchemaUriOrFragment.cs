...
/// </para>
/// </remarks>
[JsonConverter(typeof(JsonSchemaUriOrFragmentConverter))]
public class JsonSchemaUriOrFragment: IEquatable<JsonSchemaUriOrFragment>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="JsonSchemaUriOrFragment"/> class.
    /// </summary>
    /// <param name="uriString">
    /// A string containing either a URI reference that is valid according to RFC 2396,
    /// or a bare fragment.
    /// </param>
    public JsonSchemaUriOrFragment(string uriString)
    {
    ...
    /// </param>
    public JsonSchemaUriOrFragment(JsonSchemaUriOrFragment other)
    {
    ...
    /// <summary>
    /// Compares two <see cref="JsonSchemaUriOrFragment"/> instances for equality.
    /// </summary>
    ...
    {
        return Equals(comparand as JsonSchemaUriOrFragment);
    }
    ...
    public bool Equals(JsonSchemaUriOrFragment other)
    {
    ...
    public static bool operator ==(JsonSchemaUriOrFragment left, JsonSchemaUriOrFragment right)
    {
