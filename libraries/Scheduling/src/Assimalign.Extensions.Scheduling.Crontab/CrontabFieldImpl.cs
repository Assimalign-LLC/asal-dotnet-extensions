...
sealed partial class CrontabFieldImpl
{
    ...
    public static readonly CrontabFieldImpl Day = new CrontabFieldImpl(CrontabFieldKind.DayOfMonth, 1, 31, null);
    ...
    public void Parse(string str, CrontabFieldAccumulator<ExceptionProvider?> acc) => TryParse(str, acc, (ExceptionProvider?)null, ep => throw ep());
