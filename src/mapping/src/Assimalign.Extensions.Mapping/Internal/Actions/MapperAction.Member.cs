 ...
 */
internal sealed partial class MapperAction<TTarget, TTargetMember, TSource, TSourceMember> : IMapperAction
{
    private delegate void Invocation(IMapperContext context);

    public MapperAction(Expression<Func<TTarget, TTargetMember>> target, Expression<Func<TSource, TSourceMember>> source)
    {
    ...
    private Invocation MapInvoke { get; init; }
