    ...
    public abstract class HttpMessageHandlerBuilder
    {
        ...
        protected internal static HttpMessageHandler CreateHandlerPipeline(HttpMessageHandler primaryHandler, IEnumerable<DelegatingHandler> additionalHandlers)
        {
            ...
            for (int i = additionalHandlersList.Count - 1; i >= 0; i--)
            {
                ...
                if (handler == null)
                {
                    string message = "Some shit happened";//SR.Format(SR.HttpMessageHandlerBuilder_AdditionalHandlerIsNull, nameof(additionalHandlers));
                ...
                {
                    string message = "Some shit happened";
                        //SR.Format(SR.HttpMessageHandlerBuilder_AdditionHandlerIsInvalid,
