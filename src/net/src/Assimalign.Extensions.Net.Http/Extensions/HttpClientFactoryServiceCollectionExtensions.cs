...
namespace Assimalign.Extensions.Http
{
    ...
    public static class HttpClientFactoryServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddHttpClient(this IServiceCollection services)
        {
            ...
            // Core abstractions
            //
            services.TryAddTransient<HttpMessageHandlerBuilder, HttpMessageHandlerBuilderDefault>();
            services.TryAddSingleton<HttpClientFactoryDefault>();
            services.TryAddSingleton<IHttpClientFactory>(serviceProvider => serviceProvider.GetRequiredService<HttpClientFactoryDefault>());
            services.TryAddSingleton<IHttpMessageHandlerFactory>(serviceProvider => serviceProvider.GetRequiredService<HttpClientFactoryDefault>());

            //
            // Typed Clients
            //
            services.TryAdd(ServiceDescriptor.Transient(typeof(IHttpClientFactoryTyped<>), typeof(HttpClientFactoryTypedDefault<>)));
            services.TryAdd(ServiceDescriptor.Singleton(typeof(HttpClientFactoryTypedDefault<>.Cache), typeof(HttpClientFactoryTypedDefault<>.Cache)));
        ...
        public static IHttpClientBuilder AddHttpClient(this IServiceCollection services, string name)
        {
            ...
            return new HttpClientBuilderDefault(services, name);
        }
        ...
        /// </para>
        /// <para>
        /// Use <see cref="Options.Options{object}.DefaultName"/> as the name to configure the default client.
        /// </para>
        /// </remarks>
        public static IHttpClientBuilder AddHttpClient(this IServiceCollection services, string name, Action<HttpClient> configureClient)
        {
            ...
            var builder = new HttpClientBuilderDefault(services, name);
        ...
        /// a transient service. See <see cref="IHttpClientFactoryTyped{TClient}" /> for more details about authoring typed clients.
        /// </typeparam>
        /// <param name="services">The <see cref="IServiceCollection"/>.</param>
        /// <returns>An <see cref="IHttpClientBuilder"/> that can be used to configure the client.</returns>
        /// <remarks>
        ...
        /// <see cref="IHttpClientFactoryTyped{TImplementation}"/>
        /// </typeparam>
        /// <param name="services">The <see cref="IServiceCollection"/>.</param>
        /// <returns>An <see cref="IHttpClientBuilder"/> that can be used to configure the client.</returns>
        /// <remarks>
