...
namespace Assimalign.Extensions.Http
{
    ...
    public static class HttpClientBuilderExtensions
    {
        ...
        /// client binding that creates <typeparamref name="TClient"/> using the <see cref="IHttpClientFactoryTyped{TClient}" />.
        /// </para>
        /// <para>
        ...
        private static TClient AddTransientHelper<TClient>(IServiceProvider s, IHttpClientBuilder builder) where TClient : class
        {
            ...
            IHttpClientFactoryTyped<TClient> typedClientFactory = s.GetRequiredService<IHttpClientFactoryTyped<TClient>>();
        ...
        /// a transient service. See <see cref="IHttpClientFactoryTyped{TImplementation}" /> for more details about authoring typed clients.
        /// </typeparam>
        ...
        private static TClient AddTransientHelper<TClient, TImplementation>(IServiceProvider s, IHttpClientBuilder builder) where TClient : class where TImplementation : class, TClient
        {
            ...
            IHttpClientFactoryTyped<TImplementation> typedClientFactory = s.GetRequiredService<IHttpClientFactoryTyped<TImplementation>>();
            return typedClientFactory.CreateClient(httpClient);
        }
