...
namespace Assimalign.Extensions.DependencyInjection.ServiceLoopkup.ILEmit
{
    using Assimalign.Extensions.DependencyInjection.ServiceLoopkup.Kind;
    using Assimalign.Extensions.DependencyInjection.ServiceLoopkup.Helpers;
    ...
    internal sealed class ILEmitResolverBuilder : CallSiteVisitor<ILEmitResolverBuilderContext, object>
    {
        ...
        protected override object VisitIEnumerable(EnumerableCallSite enumerableCallSite, ILEmitResolverBuilderContext argument)
        {
