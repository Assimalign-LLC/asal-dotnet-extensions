...
/// <summary>
/// An <see cref="IStateToken"/> which represents one or more <see cref="IStateToken"/> instances.
/// </summary>
public class StateTokenComposite : IStateToken
{
    ...
    /// <summary>
    /// Creates a new instance of <see cref="StateTokenComposite"/>.
    /// </summary>
    /// <param name="changeTokens">The list of <see cref="IStateToken"/> to compose.</param>
    public StateTokenComposite(IReadOnlyList<IStateToken> changeTokens)
    {
    ...
    /// <summary>
    /// Returns the list of <see cref="IStateToken"/> which compose the current <see cref="StateTokenComposite"/>.
    /// </summary>
    public IReadOnlyList<IStateToken> ChangeTokens { get; }
    ...
    {
        var compositeChangeTokenState = (StateTokenComposite)state;
