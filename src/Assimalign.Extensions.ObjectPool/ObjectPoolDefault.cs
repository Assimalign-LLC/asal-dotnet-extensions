...
namespace Assimalign.Extensions.ObjectPool
{
    ...
    public class ObjectPoolDefault<T> : ObjectPool<T> where T : class
    {
        ...
        public ObjectPoolDefault(IPooledObjectPolicy<T> policy)
        ...
        public ObjectPoolDefault(IPooledObjectPolicy<T> policy, int maximumRetained)
        {
            ...
            bool IsDefaultPolicy()
            {
                ...
                return type.IsGenericType && type.GetGenericTypeDefinition() == typeof(PooledObjectPolicyDefault<>);
            }
        }
