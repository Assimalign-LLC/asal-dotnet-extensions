...
namespace Assimalign.Extensions.Options
{
    ...
    public static class OptionsBuilderConfigurationExtensions
    {
        ...
        /// <returns>The <see cref="OptionsBuilder{TOptions}"/> so that additional calls can be chained.</returns>
        [RequiresUnreferencedCode(TrimmingRequiredUnreferencedCodeMessage)]
        public static OptionsBuilder<TOptions> Bind<TOptions>(this OptionsBuilder<TOptions> optionsBuilder, IConfiguration config, Action<ConfigurationBinderOptions> configureBinder) where TOptions : class
        {
        ...
        public static OptionsBuilder<TOptions> BindConfiguration<TOptions>(
            ...
            Action<ConfigurationBinderOptions> configureBinder = null)
        ...
        private static void BindFromOptions<TOptions>(TOptions opts, IConfiguration config, string configSectionPath, Action<ConfigurationBinderOptions> configureBinder) where TOptions : class
        {
