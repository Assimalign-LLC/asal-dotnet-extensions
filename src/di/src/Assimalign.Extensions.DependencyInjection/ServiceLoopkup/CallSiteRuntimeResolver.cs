...
namespace Assimalign.Extensions.DependencyInjection.ServiceLoopkup
{
    ...
    internal sealed class CallSiteRuntimeResolver : CallSiteVisitor<CallSiteRuntimeResolverContext, object>
    {
        ...
        protected override object VisitIEnumerable(EnumerableCallSite enumerableCallSite, CallSiteRuntimeResolverContext context)
        {
