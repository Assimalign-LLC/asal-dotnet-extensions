...
public static class OptionsServiceCollectionExtensions
{
    ...
    public static IServiceCollection Configure<TOptions>(this IServiceCollection services, Action<TOptions> configureOptions) where TOptions : class
        => services.Configure(Options<TOptions>.DefaultName, configureOptions);
    ...
    public static IServiceCollection PostConfigure<TOptions>(this IServiceCollection services, Action<TOptions> configureOptions) where TOptions : class
        => services.PostConfigure(Options<TOptions>.DefaultName, configureOptions);
    ...
    /// <summary>
    /// Registers a type that will have all of its <see cref="IOptionsConfiguration{TOptions}"/>,
    /// <see cref="IOptionsPostConfiguration{TOptions}"/>, and <see cref="IOptionsValidator{TOptions}"/>
    /// registered.
    /// </summary>
    ...
    private static IEnumerable<Type> FindConfigurationServices(Type type)
    {
        foreach (Type t in GetInterfacesOnType(type))
        {
            if (t.IsGenericType)
            {
                ...
                if (gtd == typeof(IOptionsConfiguration<>) ||
                    gtd == typeof(IOptionsPostConfiguration<>) ||
                    gtd == typeof(IOptionsValidator<>))
                {
                    yield return t;
                }
            }
    ...
    /// <summary>
    /// Registers an object that will have all of its <see cref="IOptionsConfiguration{TOptions}"/>,
    /// <see cref="IOptionsPostConfiguration{TOptions}"/>, and <see cref="IOptionsValidator{TOptions}"/>
    /// registered.
    /// </summary>
    /// <param name="services">The <see cref="IServiceCollection"/> to add the services to.</param>
    ...
    public static OptionsBuilder<TOptions> AddOptions<TOptions>(this IServiceCollection services) where TOptions : class
        => services.AddOptions<TOptions>(Options<TOptions>.DefaultName);
