...
public class OptionsBuilder<TOptions> where TOptions : class
{
    ...
    public virtual OptionsBuilder<TOptions> Configure(Action<TOptions> configureOptions)
    {
        ...
        Services.AddSingleton<IOptionsConfiguration<TOptions>>(new ConfigureNamedOptions<TOptions>(Name, configureOptions));
        return this;
    }
        ...
        where TDep : class
    {
        ...
        Services.AddTransient<IOptionsConfiguration<TOptions>>(sp =>
    ...
    /// <returns>The current <see cref="OptionsBuilder{TOptions}"/>.</returns>
    public virtual OptionsBuilder<TOptions> Configure<TDep1, TDep2, TDep3>(Action<TOptions, TDep1, TDep2, TDep3> configure)
        where TDep1 : class
        where TDep2 : class
        where TDep3 : class
    {
        ...
        Services.AddTransient<IOptionsConfiguration<TOptions>>(
            serviceProvider => new ConfigureNamedOptions<TOptions, TDep1, TDep2, TDep3>(
                Name,
                serviceProvider.GetRequiredService<TDep1>(),
                serviceProvider.GetRequiredService<TDep2>(),
                serviceProvider.GetRequiredService<TDep3>(),
                configure));
        return this;
    }
    ...
    public virtual OptionsBuilder<TOptions> PostConfigure(Action<TOptions> configureOptions)
    {
        ...
        Services.AddSingleton<IOptionsPostConfiguration<TOptions>>(new PostConfigureOptions<TOptions>(Name, configureOptions));
        return this;
    }
        ...
        where TDep : class
    {
        ...
        Services.AddTransient<IOptionsPostConfiguration<TOptions>>(sp =>
        ...
        where TDep3 : class
    {
        ...
        Services.AddTransient<IOptionsPostConfiguration<TOptions>>(
    ...
    public virtual OptionsBuilder<TOptions> Validate(Func<TOptions, bool> validation, string failureMessage)
    {
        ...
        Services.AddSingleton<IOptionsValidator<TOptions>>(new OptionsValidator<TOptions>(Name, validation, failureMessage));
        return this;
    }
    ...
    public virtual OptionsBuilder<TOptions> Validate<TDep>(Func<TOptions, TDep, bool> validation, string failureMessage)
    {
        ...
        Services.AddTransient<IOptionsValidator<TOptions>>(sp =>
            new OptionsValidator<TOptions, TDep>(Name, sp.GetRequiredService<TDep>(), validation, failureMessage));
        return this;
    }
    ...
    public virtual OptionsBuilder<TOptions> Validate<TDep1, TDep2>(Func<TOptions, TDep1, TDep2, bool> validation, string failureMessage)
    {
        ...
        Services.AddTransient<IOptionsValidator<TOptions>>(sp =>
            new OptionsValidator<TOptions, TDep1, TDep2>(Name,
                sp.GetRequiredService<TDep1>(),
                sp.GetRequiredService<TDep2>(),
                validation,
                failureMessage));
    ...
    public virtual OptionsBuilder<TOptions> Validate<TDep1, TDep2, TDep3>(Func<TOptions, TDep1, TDep2, TDep3, bool> validation, string failureMessage)
    {
        ...
        Services.AddTransient<IOptionsValidator<TOptions>>(sp =>
            new OptionsValidator<TOptions, TDep1, TDep2, TDep3>(Name,
                sp.GetRequiredService<TDep1>(),
                sp.GetRequiredService<TDep2>(),
                sp.GetRequiredService<TDep3>(),
                validation,
    ...
    public virtual OptionsBuilder<TOptions> Validate<TDep1, TDep2, TDep3, TDep4>(Func<TOptions, TDep1, TDep2, TDep3, TDep4, bool> validation, string failureMessage)
    {
        ...
        Services.AddTransient<IOptionsValidator<TOptions>>(sp =>
            new OptionsValidator<TOptions, TDep1, TDep2, TDep3, TDep4>(Name,
                sp.GetRequiredService<TDep1>(),
                sp.GetRequiredService<TDep2>(),
                sp.GetRequiredService<TDep3>(),
                sp.GetRequiredService<TDep4>(),
    ...
    public virtual OptionsBuilder<TOptions> Validate<TDep1, TDep2, TDep3, TDep4, TDep5>(Func<TOptions, TDep1, TDep2, TDep3, TDep4, TDep5, bool> validation, string failureMessage)
    {
        ...
        Services.AddTransient<IOptionsValidator<TOptions>>(sp =>
            new OptionsValidator<TOptions, TDep1, TDep2, TDep3, TDep4, TDep5>(Name,
                sp.GetRequiredService<TDep1>(),
                sp.GetRequiredService<TDep2>(),
                sp.GetRequiredService<TDep3>(),
                sp.GetRequiredService<TDep4>(),
