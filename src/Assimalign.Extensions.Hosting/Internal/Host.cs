...
namespace Assimalign.Extensions.Hosting.Internal
{
    ...
    internal sealed class Host : IHost, IAsyncDisposable
    {
        ...
        private IEnumerable<IHostService> _hostedServices;
                    ...
                    IOptions<HostOptions> options)
        {
            ...
            _applicationLifetime = (applicationLifetime ?? throw new ArgumentNullException(nameof(applicationLifetime))) as HostApplicationLifetime;
        ...
        public async Task StartAsync(CancellationToken cancellationToken = default)
        {
            ...
            _hostedServices = Services.GetService<IEnumerable<IHostService>>();

            foreach (IHostService hostedService in _hostedServices)
            {
        ...
        private async Task TryExecuteBackgroundServiceAsync(HostBackgroundService backgroundService)
        {
            ...
            catch (Exception ex)
            {
                ...
                if (_options.BackgroundServiceExceptionBehavior == HostBackgroundServiceExceptionBehavior.StopHost)
                {
        ...
        public async Task StopAsync(CancellationToken cancellationToken = default)
        {
            ...
            using (var linkedCts = CancellationTokenSource.CreateLinkedTokenSource(cts.Token, cancellationToken))
            {
                ...
                {
                    foreach (IHostService hostedService in _hostedServices.Reverse())
                    {
                        try
                        {
