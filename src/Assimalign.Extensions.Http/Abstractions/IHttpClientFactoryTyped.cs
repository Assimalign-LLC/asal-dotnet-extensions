...
namespace Assimalign.Extensions.Http.Abstractions
{
    ...
    /// <remarks>
    /// <para>
    /// The <see cref="IHttpClientFactoryTyped{TClient}"/> is infrastructure that supports the
    ...
    /// </para>
    /// <para>
    /// A default <see cref="IHttpClientFactoryTyped{TClient}"/> can be registered in an <see cref="IServiceCollection"/>
    /// by calling <see cref="HttpClientFactoryServiceCollectionExtensions.AddHttpClient(IServiceCollection)"/>.
    /// The default <see cref="IHttpClientFactoryTyped{TClient}"/> will be registered in the service collection as a singleton
    /// open-generic service.
    /// </para>
    /// <para>
    /// The default <see cref="IHttpClientFactoryTyped{TClient}"/> uses type activation to create typed client instances. Typed
    ...
    /// </code>
    /// </example>
    public interface IHttpClientFactoryTyped<TClient>
    {
        /// <summary>
